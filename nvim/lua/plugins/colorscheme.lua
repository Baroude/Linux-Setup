...
-- Matugen dynamic colorscheme — no plugin to install, file lives in
-- ~/.config/nvim/colors/matugen.vim, generated by matugen on each wallpaper change.
-- Enable with: return { plugin = "matugen" } in colorscheme-flavor.lua
if plugin == "matugen" then
